...
After configuring the settings in the configuration file, you can run the model either by executing the `SindMain.py` file directly or by running the following command in the terminal:

```
python SindMain.py --config <path to config.yaml>
```
